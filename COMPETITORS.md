...
|---|---|---|---|---|---|---|
| **`@pugarhuda/brownie-to-ape`** ⭐ (this repo) | Pugar Huda | v0.7.6 | **250** (90 fixture + 125 Vitest + 35 pytest incl. Hypothesis fuzzer) | **5** (incl. Yearn Finance) | **0** (audited) | 17 passes, Stryker baseline, Docker ape-verify (CI-passed), Track 3 issue, Bahasa README |
